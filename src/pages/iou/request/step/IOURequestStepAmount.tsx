...
const IOURequestStepAmount = forwardRef<IOURequestStepAmountRef | null, IOURequestStepAmountProps>(
    (
        {
            report,
            route: {
...
IOURequestStepAmountWithFullTransactionOrNotFound.displayName = 'IOURequestStepAmount';
