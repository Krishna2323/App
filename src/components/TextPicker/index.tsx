...
function TextPicker({value, description, placeholder = '', errorText = '', validate, onInputChange, furtherDetails, rightLabel, ...rest}: TextPickerProps, forwardedRef: ForwardedRef<View>) {
