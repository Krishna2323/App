...
function TextSelectorModal({value, description = '', subtitle, onValueSelected, isTouched, onInputChange, isVisible, onClose, shouldClearOnClose, ...rest}: TextSelectorModalProps) {
